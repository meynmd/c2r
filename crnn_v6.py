...
class Encoder(nn.Module):
    def __init__(self, num_categories, batch_size, rnn_size=2048, num_rnn_layers=3, use_cuda=None, max_w=None):
        ...
        self.conv_layers = nn.Sequential(
            ConvBlock(1, 16, 16, (3, 9), stride=(1, 1), dilation=(1, 2)),        # conv1
            nn.MaxPool2d(kernel_size=(1, 2), stride=(1, 2)),

            ConvBlock(16, 16, 32, (3, 7), stride=(1, 1), dilation=(1, 4)),       # conv2
            nn.MaxPool2d(kernel_size=(1, 2), stride=(1, 2)),

            ConvBlock(32, 32, 64, (3, 5), stride=(1, 1), dilation=(1, 8)),       # conv3
            nn.MaxPool2d(kernel_size=(1, 2), stride=(1, 2)),

            ConvBlock(64, 64, 128, (3, 3), stride=(1, 1), dilation=(1, 16)),      # conv4
            nn.MaxPool2d(kernel_size=(2, 2), stride=(2, 2)),

            ConvBlock(128, 128, 256, (3, 3), stride=(1, 1), dilation=(1, 32)),    # conv5
            nn.MaxPool2d(kernel_size=(2, 2), stride=(2, 2)),

            ConvBlock(256, 256, 512, (3, 3), stride=(1, 1), dilation=(1, 32)),    # conv6
            nn.MaxPool2d(kernel_size=(2, 2), stride=(2, 2)),

            ConvBlock(512, 512, 1024, (3, 3), stride=(1, 1), dilation=(1, 64)),   # conv7
            nn.MaxPool2d(kernel_size=(2, 2), stride=(2, 2)),
