...
class Encoder(nn.Module):
    def __init__(self, num_categories, batch_size, rnn_size=2048, num_rnn_layers=3, use_cuda=None, max_w=None):
        ...
        self.conv_layers = nn.Sequential(
            ConvBlock(1, 16, 16, (3, 9), padding=(1, 2), stride=(1, 1), dilation=(1, 4)),        # conv1
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=(1, 2), stride=(1, 2)),

            ConvBlock(16, 16, 32, (3, 7), stride=(1, 1), padding=(1, 2), dilation=(1, 4)),       # conv2
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=(1, 2), stride=(1, 2)),

            ConvBlock(32, 32, 64, (3, 5), padding=(1, 2), stride=(1, 1), dilation=(1, 2)),       # conv3
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=(1, 2), stride=(1, 2)),

            ConvBlock(64, 64, 128, (3, 3), padding=(1, 1), stride=(1, 1), dilation=(1, 2)),      # conv4
            nn.ReLU(),
