...
class Encoder(nn.Module):
    def __init__(self, batch_size, use_cuda=None, max_w=None):
        ...
        self.name = 'encoder cnn v3'
        self.max_w = max_w
        self.batch_size = batch_size
        self.cuda_dev = use_cuda

        self.conv_layers = nn.Sequential(
            ConvBlock('A', 1, 16, 16, (3, 7), stride=(1, 1), dilation=(1, 1)),        # conv1
            nn.MaxPool2d(kernel_size=(1, 2), stride=(1, 2)),

            ConvBlock('B', 16, 16, 32, (3, 5), stride=(1, 1), dilation=(1, 1)),       # conv2
            nn.MaxPool2d(kernel_size=(1, 2), stride=(1, 2)),

            ConvBlock('B', 32, 32, 64, (3, 3), stride=(1, 1), dilation=(2, 2)),       # conv3
            # nn.MaxPool2d(kernel_size=(1, 2), stride=(1, 2)),

            ConvBlock('B', 64, 64, 128, (3, 3), stride=(1, 1), dilation=(4, 4)),      # conv4
            # nn.MaxPool2d(kernel_size=(1, 2), stride=(1, 2)),

            ConvBlock('B', 128, 128, 256, (3, 3), stride=(1, 1), dilation=(8, 8)),    # conv5
            # nn.MaxPool2d(kernel_size=(1, 2), stride=(1, 2)),

            ConvBlock('B', 256, 256, 512, (3, 3), stride=(1, 1), dilation=(16, 16)),    # conv6
            # nn.MaxPool2d(kernel_size=(1, 2), stride=(1, 2)),
