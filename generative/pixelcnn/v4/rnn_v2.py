...
class Downsample(nn.Module):
    def __init__(self, batch_size, use_cuda=None, max_w=None):
        ...
        self.conv_layers = nn.Sequential(
            ...
            ConvBlock('B', 256, 256, 512, (3, 3), stride=(1, 1), dilation=(32, 8)),  # conv7
...
class AutoEncoder(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.name = 'cnn-rnn autoencoder v2'
        ...
        self.rnn_size = 1024
        self.rnn = nn.LSTM(32*88, self.rnn_size, num_layers=1, bidirectional=False)
